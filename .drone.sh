...
go build -ldflags '-extldflags "-static" -X github.com/go-dronex/dronex/version.VersionDev=build.'${DRONE_BUILD_NUMBER} -o release/drone-server github.com/go-dronex/dronex/extras/cmd/drone-server
